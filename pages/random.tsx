...
// styles
const Button = 'border border-slate-900 py-2 bg-white rounded-md hover:border-yellow-500 hover:text-yellow-300 hover:bg-slate-900 md:active:scale-90 transition duration-300';
